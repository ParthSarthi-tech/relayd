...
import { ArrowRight, Eye, EyeOff, KeyRound, Mail, Shield, Sparkles, Zap } from 'lucide-react'
    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden flex-1 flex-col justify-between overflow-hidden bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 p-12 lg:flex">
        ...
        <div className="relative z-10 max-w-md">
          ...
          >
            Automatic retries, HMAC signing, real-time monitoring, and dead-letter queues — all in one platform.
          </motion.p>
      ...
      <div className="flex flex-1 items-center justify-center bg-zinc-50 px-6 py-12 dark:bg-background">
        ...
        >
          ...
          >
            ...
            <Link to="/register" className="font-medium text-foreground hover:underline underline-offset-2 transition-all">
              Sign up
            </Link>
          </motion.p>
        </motion.div>
