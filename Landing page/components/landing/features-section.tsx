...
const features = [
  {
    ...
    description: "Automatic retries with exponential backoff ensure every webhook reaches its destination. Dead-letter queues capture failed deliveries for later inspection and replay.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Payload Signing",
    description: "HMAC-SHA256 and HMAC-SHA512 signing with versioned key rotation. Verify that every webhook payload is authentic and untampered, straight from the source.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Real-time Monitoring",
    description: "Live delivery dashboard with per-message attempt timelines. Track every retry, response code, and latency metric in real time with full observability.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Enterprise Security",
    description: "Circuit breaker protection, per-endpoint rate limiting, comprehensive audit logging, and configurable data retention policies to meet compliance requirements.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Every webhook feature
            <br />
            <span className="text-muted-foreground">you&apos;ll ever need.</span>
          </h2>
        </div>
